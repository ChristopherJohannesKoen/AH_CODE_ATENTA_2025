...
class RunRequest(BaseModel):
    audio: str = Field(..., description="Path to audio file (e.g., resources\\audio\\consultation_x1_combined_dialogue.mp3)")
    ...
    hf_token: Optional[str] = Field(None, description="HF token if diarization is enabled")
    role_map: Optional[Dict[str, str]] = Field(None, description='e.g. {"SPEAKER_00":"Doctor","SPEAKER_01":"Patient"}')
